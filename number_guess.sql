...
INSERT INTO public.users VALUES (1, 'user_1726661112076');
...
--
-- Name: games fk_users_games_userid; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_users_games_userid FOREIGN KEY (user_id) REFERENCES public.users(user_id);
